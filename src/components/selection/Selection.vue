    ...
    <div ref="menuWrapper" v-if="banner.length" class="list-fixedHead">
      <div class="list">
        <ul class="list-group"
          ...
          <li v-for="item in list" class="list-content">
            <div class="header">
              <img class="avatar">
            ...
            <div class="meta">
              <span class="like it-left">
                <i @click="likeClick($event), item._incrs.like += 1" class="icon active-like"></i>
                <span class="num">{{item._incrs.like}}</span>
              </span>
              <span class="dislike it-left">
                <i @click="dislikeClick($event), item._incrs.dislike += 1" class="icon active-dislike"></i>
...
//          like.classNanme = 'animated bounceOutLeft'
          setTimeout(function () {
//            this.showPlus = false
            $('.plus').removeClass('animated bounceInDown').css('display', 'none')
            $(like).removeClass('animated flip')
          }, 2000)
        })
      },
...
//            this.showPlus = false
            $('.plus').removeClass('animated bounceInDown').css('display', 'none')
            $(dislike).removeClass('animated flip')
          }, 2000)
        })
      },
      showWrap () {
