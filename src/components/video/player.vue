    ...
    <div class="container">
      <div class="__cov-video-container" @mouseenter="mouseEnterVideo" @mouseleave="mouseLeaveVideo">
        <video :class="{ 'hide-cursor': !state.contrlShow }" class="__cov-video" :poster="options.poster">
          <!--<source v-for="source in video.source" :src="source.src" :type="source.type">-->
          <source src="http://m.mp4pa.com/wangpan/down.php/83196c65f8c5ef742de7f6221a7e5d07.mp4http://m.mp4pa.com/wangpan/down.php/83196c65f8c5ef742de7f6221a7e5d07.mp4" type="mp4"/>
        </video>
